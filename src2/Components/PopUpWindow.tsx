...
import { Form, Table, DatePicker, Radio } from "antd";
...
interface PopupModelaForecastProps {
  availableColumns: any; 
  onClose: () => void;
  onSubmit: ({
    forecastTitle,
    forecastRange,
    forecastType
  }: ForecastParameterType) => void;
}
export interface ForecastParameterType {
    forecastTitle: string;
    forecastRange: any;
    forecastType: string 
}
export const PopupModalForecast: React.FC<PopupModelaForecastProps> = ({
  availableColumns,
  onClose,
  onSubmit,
}) => {
  ...
  const onModalSubmit = () => {
    const newData: ForecastParameterType = {
